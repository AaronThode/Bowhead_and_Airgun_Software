...
%               index of a multi-element feature to extract (e.g. "2" to access frequency  of Centroid, which is a 2-element vector)
...
for I=1:Ncalls_raw %For each energy detection
    if rem(I,500)==0,fprintf('create_station: %i percent done\n',round(100*I/Ncalls));end
     ...
     for J=1:length(features{I})  %Review each detection within energy detection
        ...
        for Ishape=1:Nshape_max  %Number of segments allowed per station...
